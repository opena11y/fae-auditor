...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=24, verbose_name=b'Group Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('element', models.CharField(max_length=24, verbose_name=b'Element')),
                ('attribute', models.CharField(max_length=24, verbose_name=b'Attribute')),
                ('event', models.CharField(max_length=24, verbose_name=b'Event')),
                ('count', models.IntegerField(default=0)),
