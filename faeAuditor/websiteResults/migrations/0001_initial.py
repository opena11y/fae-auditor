# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2017-12-26 16:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group2_result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ws_results', to='auditGroup2Results.AuditGroup2Result')),
                ('group_result', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ws_results', to='auditGroupResults.AuditGroupResult')),
