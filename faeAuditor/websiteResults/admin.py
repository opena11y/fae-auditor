...
class WebsiteResultAdmin(admin.ModelAdmin):
    list_display = ('url', 'audit_result', 'title', 'status', 'depth', 'page_count', 'max_pages', 'slug', 'archive', 'ruleset', 'depth', 'created', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_score', 'implementation_status', 'implementation_pass_fail_score', 'implementation_pass_fail_status')
