...
class WebsiteResultAdmin(admin.ModelAdmin):
    list_display = ('url', 'audit_result', 'title', 'status', 'depth', 'page_count', 'max_pages', 'slug', 'archive', 'ruleset', 'depth', 'created', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_score', 'implementation_score_fail', 'implementation_score_mc', 'implementation_status', 'implementation_pass_fail_score', 'implementation_pass_fail_status')
...
class WebsiteRuleCategoryResultAdmin(admin.ModelAdmin):
    list_display = ('rule_category', 'slug', 'ws_report', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_pass_fail_score', 'implementation_score', 'implementation_score_fail', 'implementation_score_mc', 'implementation_status')
...
class WebsiteGuidelineResultAdmin(admin.ModelAdmin):
    list_display = ('guideline', 'slug', 'ws_report', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_pass_fail_score', 'implementation_score', 'implementation_score_fail', 'implementation_score_mc', 'implementation_status')
...
class WebsiteRuleScopeResultAdmin(admin.ModelAdmin):
    list_display = ('rule_scope', 'slug', 'ws_report', 'rules_violation', 'rules_warning', 'rules_manual_check', 'rules_passed', 'implementation_pass_fail_score', 'implementation_score', 'implementation_score_fail', 'implementation_score_mc', 'implementation_status')
...
class WebsiteRuleResultAdmin(admin.ModelAdmin):
    list_display = ('rule', 'ws_report', 'result_value', 'pages_violation', 'pages_warning', 'pages_manual_check', 'pages_passed', 'pages_na', 'implementation_pass_fail_score', 'implementation_score', 'implementation_score_fail', 'implementation_score_mc', 'implementation_status')
